...
export default function Contatti() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Head>
        <title>Contatti • Ristorante Aura</title>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-grigio mt-1">
                      <a href="mailto:info@ristoranteaura.it" className="hover:text-bosco transition">info@ristoranteaura.it</a>
                    </p>
                    <p className="text-grigio mt-1">
                      <a href="mailto:prenotazioni@ristoranteaura.it" className="hover:text-bosco transition">prenotazioni@ristoranteaura.it</a>
                    </p>
                  </div>
                </div>
              </div>
