...
export default function ChiSiamo() {
  const teamMembers = [
    ...
    },
    {
      ...
      image: '/images/chef-giovanni.jpg'
    }
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Head>
        <title>Chi Siamo • Ristorante Aura</title>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-5xl mx-auto px-6">
            ...
            <div className="prose max-w-3xl mx-auto text-grigio">
              <p className="mb-6">
                Fondato nel cuore di Roma nel 1995, il Ristorante Aura nasce dalla passione per la cucina tradizionale italiana, 
              ...
              <div className="space-y-12">
                {milestones.map((milestone, index) => (
                  ...
                  >
                    <div className="hidden md:block md:w-1/2 px-8 py-4">
                      {index % 2 === 0 ? (
                        <div className="text-right">
                          <span className="text-oro font-serif text-2xl block mb-2">{milestone.year}</span>
                    ...
                    <div className="flex-1 md:absolute md:inset-0 flex items-center justify-center relative pointer-events-none">
                      <div className="hidden md:block w-6 h-6 rounded-full bg-oro border-4 border-white"></div>
